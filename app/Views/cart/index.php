                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="pelanggan" class="form-control" 
                                       value="<?= session()->get('cart_pelanggan') ?? '' ?>" 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <select name="layanan_id" class="form-select" required>
                                    ...
                                    <?php 
                                    // Load layanan dari session atau default
                                    $layananList = session()->get('layanan_data');
                                    if (!$layananList) {
                                        // Default layanan jika session kosong
                                        $layananList = [
                                        ...
                                        session()->set('layanan_data', $layananList);
                                    }
                                    
                                    foreach($layananList as $l): 
                                    ?>
                                        <option value="<?= $l['id'] ?>">
                                            <?= $l['nama'] ?> - Rp <?= number_format($l['harga'], 0, ',', '.') ?>/<?= $l['satuan'] ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        ...
                        <div class="mt-3">
                            <form action="/transaksi/checkout" method="post">
                                ...
                                <button type="submit" class="btn btn-success w-100">
                                    <i class="bi bi-check-circle me-1"></i> Checkout / Bayar
                                </button>
                            </form>
                            <a href="/keranjang/clear" class="btn btn-outline-danger w-100 mt-2" 
