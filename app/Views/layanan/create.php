...
<div class="pagetitle"><h1>Tambah Layanan Baru</h1><nav><ol class="breadcrumb"><li class="breadcrumb-item"><a href="/">Home</a></li><li class="breadcrumb-item"><a href="/layanan">Layanan</a></li><li class="breadcrumb-item active">Tambah</li></ol></nav></div>
                ...
                <div class="card-body">
                    ...
                    <form action="/layanan/store" method="post">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9"><input type="number" name="harga" class="form-control" required></div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9"><input type="text" name="estimasi" class="form-control" placeholder="Contoh: 2-3 hari" required></div>
                        </div>
                        <div class="row mb-3">
